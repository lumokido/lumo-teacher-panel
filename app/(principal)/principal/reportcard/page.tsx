...
export default function PrincipalReportCardPage() {
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      {/* Header */}
      <div>
        <p className="mb-2 text-sm font-medium text-violet-600">Report Cards</p>
        <h2 className="font-montserrat text-3xl font-semibold text-slate-900">
          Gradebook & Report Cards
        </h2>
        <p className="mt-2 text-slate-600 max-w-2xl">
          Select a class and examination series to enter student marks. Use Tab to navigate through fields, and press Enter to save and advance automatically.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white border border-violet-100 rounded-2xl p-6 shadow-sm">
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full rounded-xl border border-slate-200 bg-white py-2.5 px-4 text-sm text-slate-900 outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-100 transition-all"
          >
